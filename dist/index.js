...
var Template;
(function (Template) {
    Template["Express_Nodewatch"] = "express-nodewatch";
    Template["Express_Nodewatch_Cors"] = "express-nodewatch-cors";
    Template["Express_Nodemon"] = "express-nodemon";
    Template["Express_Nodemon_Cors"] = "express-nodemon-cors";
})(Template || (Template = {}));
// **************************** Constants/enums ****************************
async function init() {
    ...
    let template = Template.Express_Nodewatch;
    ...
    const pkgJSON = JSON.parse(fs.readFileSync(path.join(templateDir, "package.json"), {
        encoding: "utf8",
    }));
